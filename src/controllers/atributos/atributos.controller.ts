...
export class AtributosController {
    constructor(private atributosService: AtributosService, private atributosEstaticosService: AtributosEstaticosService) {}
    ...
    @UseInterceptors(LoggingInterceptor)
    @Post('update/:id')
    async updateRole(@Param() params, @Body() atributo: CreateAtributo): Promise<any> {
