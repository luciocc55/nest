...
export class ElegibilidadController {
  ...
  @ApiTags(
    ...
    "Galeno (Traditum):Sitio Emisor Galeno:Usuario Galeno:Password Galeno:Codigo de Provincia:Numero de Prestador:Tipo de identificador:Descripción de prestador",
